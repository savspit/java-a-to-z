...
public class TrackerTest {
    ...
    public void testAdd() throws Exception {
        ...
        Task task1 = new Task("first task", "first desc", String.valueOf(System.nanoTime()));
    ...
    public void testUpdate() throws Exception {
        ...
        Task task1 = new Task("second task", "second desc", String.valueOf(System.nanoTime()));
        tracker.add(task1);

        Task taskToUpdate = new Task("updated task", task1.getDescription(), String.valueOf(task1.getCreate()));
