...
public class StartUI {
    ...
    public static void main(String[] args) {
        ...
        tracker.add(task6);
        System.out.println("founded task is: " + tracker.findBy(task6.getName()));
        ...
        // find by create
        Task task7 = new Task("seventh task", "seventh desc", 271545279656360L);
        tracker.add(task7);
        System.out.println("founded task is: " + tracker.findBy(271545279656360L));
