 ...
 */
class UpdateItem extends MyActionElement {
...
public class MenuTracker {
    ...
    public MenuTracker(Input input, Tracker tracker, int size) {
        ...
        this.actions = new MyAction[size];
    }
     ...
     */
    public void show() {
        for (MyAction action : this.actions) {
     ...
     * Creates new menu action
     */
    private class AddItem extends MyActionElement {
     ...
     * Creates new menu action
     */
    private class DeleteItem extends MyActionElement {
     ...
     * Creates new menu action
     */
    private class AddCommentToItem extends MyActionElement {
     ...
     * Creates new menu action
     */
    private class FindItemByName extends MyActionElement {
     ...
     * Creates new menu action
     */
    private class FindItemByDescription extends MyActionElement {
     ...
     * Creates new menu action
     */
    private class FindItemByCreate extends MyActionElement {
     ...
     * Creates new menu action
     */
    public static class ShowItems extends MyActionElement {
